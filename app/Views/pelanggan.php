            ...
            <?php if (!empty($pelanggan)): ?>
                <?php foreach ($pelanggan as $customer): ?>
                    <tr>
                        ...
                        <td>
                        <a href="<?= base_url('/pelanggan/edit_customer/' . $customer['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <script>document.write(new Date().getFullYear());</script> - Dikembangkan oleh <b><a href="https://www.example.com" target="_blank">Elvin Suberjun</a></b>
        </div>
    </div>
</footer>
<!-- Footer -->
